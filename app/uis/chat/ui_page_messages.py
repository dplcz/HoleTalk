...
################################################################################
## Form generated from reading UI file 'page_messages.ui'
##
...
"}\n"
"#btn_mic_top {	\n"
"	background-image: url(:/icons_svg/images/icons_svg/mic.svg);\n"
"}\n"
"#btn_delete_top {	\n"
"	background-image: url(:/icons_svg/images/icons_svg/delete.svg);\n"
"}\n"
"#btn_voice_top{\n"
"	background-image: url(:/icons_svg/images/icons_svg/voice.svg);\n"
"}\n"
"/* BO"
                        "TTOM */\n"
"#bottom QPushButton {\n"
...
"}")
        ...
        self.btn_voice_top = QPushButton(self.top)
        self.btn_voice_top.setObjectName(u"btn_voice_top")
        self.btn_voice_top.setMinimumSize(QSize(40, 40))
        self.btn_voice_top.setMaximumSize(QSize(40, 40))
        self.btn_voice_top.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout.addWidget(self.btn_voice_top)

        self.btn_mic_top = QPushButton(self.top)
        self.btn_mic_top.setObjectName(u"btn_mic_top")
        self.btn_mic_top.setMinimumSize(QSize(40, 40))
        self.btn_mic_top.setMaximumSize(QSize(40, 40))
        self.btn_mic_top.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout.addWidget(self.btn_mic_top)

        self.btn_delete_top = QPushButton(self.top)
        self.btn_delete_top.setObjectName(u"btn_delete_top")
        self.btn_delete_top.setMinimumSize(QSize(40, 40))
        self.btn_delete_top.setMaximumSize(QSize(40, 40))
        self.btn_delete_top.setCursor(QCursor(Qt.PointingHandCursor))

        self.horizontalLayout.addWidget(self.btn_delete_top)
...
#         self.chat_messages.setStyleSheet(u" \n"
# "	background-position: center;\n"
# "	background-repeat: no-repeat;\n"
...
# "")
        ...
        self.messages_frame.setStyleSheet(u"")
    ...
    def retranslateUi(self, chat_page):
        ...
        self.btn_voice_top.setText("")
        self.btn_mic_top.setText("")
        self.btn_delete_top.setText("")
