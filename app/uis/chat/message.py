...
class Message(QWidget):
    def __init__(self, message, me_send, date_time=None, server=False, split=False):
        ...
        self.date_message.setText(str(date_time_format))
    ...
    def setup_ui(self):
        ...
        if self.server:
            self.message.setStyleSheet("font: 500 11pt 'Segoe UI';color:red;")
        elif self.split:
            self.message.setStyleSheet("font: 500 11pt 'Segoe UI';color:rgb(189, 255, 0);")
        else:
        ...
        # LABEL MESSAGE 
        self.date_message = QLabel()
        self.date_message.setText("date")
        self.date_message.setStyleSheet("font: 8pt 'Segoe UI'; color: #4c5154")
        if send_by:
            self.date_message.setAlignment(Qt.AlignRight)
        else:
            self.date_message.setAlignment(Qt.AlignLeft)

        self.layout_inside.addWidget(self.message)
        self.layout_inside.addWidget(self.date_message)
